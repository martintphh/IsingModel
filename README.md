# Ising Model
This project simulates the two dimensional Ising model on a square lattice using the Metropolis algorithm.
...
```bash
python -m scripts.run_temperature_scan 2.0 2.6 64 --Tstep 0.2 --sweeps 30000 --burn_in 8000             
```
...
A simulation on a 64x64 grid at temperature 1.0 can be animated by
```bash
    python3 -m scripts.run_animation 64 2.2 --sweeps 1000 --save_every 10 --save_as ising_T22
```
